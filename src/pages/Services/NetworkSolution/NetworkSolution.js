...
import Netsolved from '../../Home/Slider/NetworkSolution';
      ...
      <div className="row justify-content-center">
        <div className="col-lg-7">
          <div className="bread-titlev2">
            ...
            We deploy communication and entertainment solutions for the Homes and SME's that are very reliable and cost effective.
      ...
      <div className="row justify-content-center">
        <div className="col-lg-8">
          <div className="common-heading ptag">
            <h2> Network Services Made For You!</h2>
          </div>
        </div>
      </div>
      <div className="row justify-content-center">
        <div className="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
          <div className="s-block wide-sblock">
            ...
            <div className="s-block-content">
              ...
              <p>
                Direct connection is the key to a fast and responsive customer experience. Our Connectivity services ensure critical support for your business operations and customers. 
              </p>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
          <div className="s-block wide-sblock">
            ...
            <div className="s-block-content">
              ...
              <p>
               Skylight infrastructure services provides reliable connectivity based solutions to customers in various geographical locations both locally and internationally
            </p>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
          <div className="s-block wide-sblock">
            ...
            <div className="s-block-content">
              ...
              <p>
               Skylight Managed network security aims at protecting the usability and integrity of your network and data. It includes both hardware and software technologies.
            </p>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
          <div className="s-block wide-sblock">
            ...
            <p>
                Our Unified communication tool enables businesses improve their processes and productivity. Services available are Voice Services, Triple-Play, sharing of features for group collaboration, secure instant messaging with ability to link external servers.
            </p>
        ...
        <div className="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
          <div className="s-block wide-sblock">
            ...
            <div className="s-block-content">
              <h4>
                Enterprise, Government and Retail
            </h4>
              <p>
                Be it an emergency or a social service, the government, organization or agency requires a solution that will enable it respond swiftly, effectively and efficiently, anywhere and at any time.
            </p>
            </div>
          </div>
        </div>
