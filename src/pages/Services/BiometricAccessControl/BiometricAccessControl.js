        ...
        <div className="col-lg-7">
          <div className="bread-titlev2">
            ...
            <p style={{fontSize:'21px'}} className="mt20 wow fadeInUp" data-wow-delay=".4s">
                We provide a tailored access control system with added security and a ‘touchless’ solution.
            </p>
...
export default BiometricAccessControl;