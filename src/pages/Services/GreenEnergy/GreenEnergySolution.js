...
import GreenEner from '../../Home/Slider/GreenEner';

const GreenEnergySolution = () =>{
    return(
  <div>
          ...
          <div className="bread-titlev2">
            ...
            {{fontSize: '40PX',
             ...
             boxSizing:'border-box'
                ...
                Incredible Solar Energy. Empowering the Furture
            </h1>
            <p style={{fontSize:'21px'}} className="mt20 wow fadeInUp" data-wow-delay=".4s">
                State-of-the-art photovoltaic (PV) systems used to harness and distribute the sun’s natural energy have become fine-tuned. They’re efficient, unobtrusive, futuristically good-looking, durable, and reliably save money for years and years.
            </p>
      ...
      <div className="row justify-content-center">
        <div className="col-lg-8">
          <div className="common-heading ptag">
            <h2> Green Energy Services Made For You!</h2>
          </div>
        </div>
      </div>
      <div className="row justify-content-center">
        ...
        <div className="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
          <div className="s-block wide-sblock">
            ...
            <div className="s-block-content">
              <h4>
              Free yourself From High Electricity!
            </h4>
            <p>
...
export default GreenEnergySolution;